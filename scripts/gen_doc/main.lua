--- The file that auto-creates documentation for `xdo`.
...
---
---@param text string Any text, e.g. `"xdo.ClassName"`.
---@return string # The wrapped text, e.g. `"*xdo.ClassName*"`.
---
...
---    The real name for the module. e.g. `"xdo"`.
---
...
---@class xdo.AutoDocumentationEntry
...
---
---@param paths xdo.AutoDocumentationEntry[]
...
local function main()
  ...
  local paths = {
    {
      source = vim.fs.joinpath(root, "lua", "xdo", "init.lua"),
      destination = vim.fs.joinpath(root, "doc", "xdo_api.txt"),
    },
    {
      source = vim.fs.joinpath(root, "lua", "xdo", "types.lua"),
      destination = vim.fs.joinpath(root, "doc", "xdo_types.txt"),
    },
  }
